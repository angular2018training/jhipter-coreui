...
export class WeightService {
    ...
    private resourceSearchExampleUrl = SERVER_API_URL + 'api/_search_example/weights';
    ...
    searchExample(req? : any): Observable<HttpResponse<Weight[]>> {
            const options = createRequestOption(req);
        return this.http.get<Weight[]>(this.resourceSearchExampleUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Weight[]>) => this.convertArrayResponse(res));
    }
