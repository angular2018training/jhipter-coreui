...
export class CompanyService {
    ...
    private resourceSearchExampleUrl = SERVER_API_URL + 'api/_search_example/companies';
    ...
    searchExample(req? : any): Observable<HttpResponse<Company[]>> {
            const options = createRequestOption(req);
        return this.http.get<Company[]>(this.resourceSearchExampleUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<Company[]>) => this.convertArrayResponse(res));
    }
