...
,OrderServicesTypeSearchRepository orderServicesTypeSearchRepository,OrderServicesTypeMapper  orderServicesTypeMapper
    ...
    public Page<OrderServicesDTO> findAll(Pageable pageable) {
        ...
        return orderServicesRepository.findAll(pageable)
            .map(orderServicesMapper::toDto);
    }
    ...
    public Page<OrderServicesDTO> searchExample(OrderServicesSearchDTO searchDto, Pageable pageable) {
            ...
            List<OrderServicesDTO> orderServicesList =  StreamSupport
            .stream(orderServicesPage.spliterator(), false)
            .map(orderServicesMapper::toDto)
