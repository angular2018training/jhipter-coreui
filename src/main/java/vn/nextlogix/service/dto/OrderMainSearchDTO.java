 ...
 */
public class OrderMainSearchDTO implements Serializable {
...
OrderMainSearchDTO orderMainSearchDTO = (OrderMainSearchDTO) o;
    if(orderMainSearchDTO.getId() == null || getId() == null) {
    return false;
    }
    return Objects.equals(getId(), orderMainSearchDTO.getId());
    }
