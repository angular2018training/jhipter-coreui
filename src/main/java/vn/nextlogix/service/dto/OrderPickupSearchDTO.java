 ...
 */
public class OrderPickupSearchDTO implements Serializable {
...
OrderPickupSearchDTO orderPickupSearchDTO = (OrderPickupSearchDTO) o;
    if(orderPickupSearchDTO.getId() == null || getId() == null) {
    return false;
    }
    return Objects.equals(getId(), orderPickupSearchDTO.getId());
    }
